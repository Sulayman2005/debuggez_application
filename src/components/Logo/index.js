...
const Logo = ({ size }) => (
  <div className="Logo">
    <svg
      width={size === "large" ? "160" : "130"} /* ternaire pour la width de l'image */
      height={size === "large" ? "60" : "60"} /* ternaire pour la height de l'image */
      viewBox="0 0 130 50"
      fill="none"
    ...
    >
      ...
      {/* modification des éléments de style poour modifier l'écriture du logo et sa taille respective */}
      <defs>
        <linearGradient
